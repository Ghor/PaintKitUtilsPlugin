...
void protobuf_AddDesc_tf_5fproto_5fdef_5fmessages_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "FieldOptions\030\377\242\004 \001(\010:\005falseB\005H\001\200\001\000", 20434);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // optional .CMsgQuestObjectiveDef.ETF2Team team = 10 [default = TF_TEAM_RED];
      case 10: {
        if (tag == 80) {
         parse_team:
          int value;
      ...
      // optional .LogicalOperation condition_logic = 14 [default = AND];
      case 14: {
        if (tag == 112) {
      ...
      // optional .LogicalOperation item_logic = 16 [default = AND];
      case 16: {
        if (tag == 128) {
         parse_item_logic:
          int value;
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // optional .ENodeCashReward cash_reward = 19 [default = CASH_REWARD_NONE];
      case 19: {
        if (tag == 152) {
         parse_cash_reward:
          int value;
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // required .LogicalOperation operation = 1 [default = AND];
      case 1: {
        if (tag == 8) {
          int value;
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
